...
@Schema(description = "전시 제작자 간단 정보 DTO")
@Getter
@Builder(access = AccessLevel.PRIVATE)
public class ExhibitionUserResDto {
    ...
    public static ExhibitionUserResDto of(Long id, String name, String description, List<ArtType> artTypes,
                                          String profileImgUrl, Boolean isFollow) {
        return ExhibitionUserResDto.builder()
                .id(id)
                .name(name)
