...
@Schema(description = "작품 정보 응답 DTO")
@Getter
...
public class ArtResDto {
    ...
    @Schema(description = "작품 등록자 정보 DTO", example = "작가 작품이라면 작가 정보 / 소장 작품이라면 컬렉터 정보")
    private final UserResDto userRes;

    @Schema(description = "하트 개수", example = "1")
    private final int heartCount;

    @Schema(description = "작품 설명", example = "이 작품을 소장하게 된 이유는 ~")
